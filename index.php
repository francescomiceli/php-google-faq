...
<body>
    ...
    <header id="site_header">
        <div class="row align-items-center">
            <img src="https://biografieonline.it/img/bio/g/Google.jpg" class="img-fluid ms-2" alt="immagine del logo di Google">
            <span class="w-auto">
                <h1 class="text-secondary fs-2">Privacy e Termini</h1>
            </span>
        </div>
       <ul class="nav">
            <li class="nav-item">
